...
class TestUILogicwindow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.window.account.login.return_value = (True, "Success", {"idToken": "fake_token", "localId": "fake_uid"})
    ...
    def test_login_successful(self):
        ...
        with patch.object(self.window, "window") as mock_window:
            ...
            mock_window.assert_called_once_with("fake_uid", "fake_token")
    ...
    def test_window_function(self):
        with patch("All_Files.view.login.MenuWindow") as mock_menu:
            ...
            self.window.window("fake_uid", "fake_token")
            instance.show.assert_called_once()
